...
const Location = () => {
  return (
    <>
      <section className="container mx-auto px-4 py-6 location">
        <h2 className="insuranceTitle">Have a question?</h2>
        <div className="contact-location-wrapper py-5 grid md:grid-cols-1 lg:grid-cols-2 gap-5">
