...
const TermsAndConditions = () => {
  return (
    <>
      <Navbar />
      <section className="container mx-auto px-4 text-black terms-section">
        <h2 className="text-center">TERMS AND CONDITIONS</h2>
        <p>Last updated: 2023-02-23</p>
        <p className="terms-para">
          1. <b>Introduction</b>
        </p>
        <p>
          Welcome to <b>Atlas</b> (“Company”, “we”, “our”, “us”)!
        </p>
        <p>
          These Terms of Service (“Terms”, “Terms of Service”) govern your use
          of our website located at <b>atlas.com.hr</b> (together or
          individually “Service”) operated by <b>Atlas</b>.
        </p>
        <p>
        ...
        <p>
          ...
          <b>velalukaatlas@gmail.com</b> so we can try to find a solution. These
        ...
        <p>
          We issue refunds for Contracts within <b>2 days</b> of the original
        ...
        <p>
          Atlas has the right but not the obligation to monitor and edit all
          Content provided by users.
        </p>
        <p>
          In addition, Content found on or through this Service are the property
          of Atlas or used with permission. You may not distribute, modify,
        ...
        <p>
          ...
          property of Atlas and its licensors. Service is protected by
          ...
          without the prior written consent of Atlas.
        </p>
        <p className="terms-para">
        ...
        <p>
          ...
          to velalukaatlas@gmail.com, with the subject line: “Copyright
        ...
        <p>
          You may provide us either directly at velalukaatlas@gmail.com or via
        ...
        <p>
          ...
          that are not owned or controlled by Atlas.
        </p>
        <p>
          Atlas has no control over, and assumes no responsibility for the
        ...
        <p>
          ...
          laws of Vela Luka, which governing law applies to agreement without
        ...
        <p>
          ...
          email: <b>velalukaatlas@gmail.com</b>.
        </p>
      </section>
    </>
  );
