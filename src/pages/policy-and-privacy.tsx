  ...
  return (
    <>
      ...
      <section className="container mx-auto px-4 text-black terms-section">
        ...
        <p>
          Welcome to <b> Atlas</b>.
        </p>
        <p>
          <b>Atlas</b> (“us”, “we”, or “our”) operates <b>atlas.com.hr</b>{" "}
          (hereinafter referred to as <b>“Service”</b>).
        </p>
        <p>
          Our Privacy Policy governs your visit to <b>atlas.com.hr</b>, and
        ...
        <p>
          <b>SERVICE</b> means the atlas.com.hr website operated by Atlas.
        </p>
        <p>
        ...
        <p>Atlas uses the collected data for various purposes:</p>
        ...
        <p>
          Atlas will take all the steps reasonably necessary to ensure that your
        ...
        <p>
          ...
          us at <b>velalukaatlas@gmail.com</b>.
        </p>
        ...
        <p>
          ...
          please send your request(s) by email: <b>velalukaatlas@gmail.com</b>.
        </p>
        <p>
